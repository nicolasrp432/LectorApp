  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-background-light dark:bg-background-dark font-display p-6 relative">
      ...
      <div className="absolute top-4 left-4 z-20 flex gap-2">
        ...
        <button onClick={() => setShowGuide(true)} className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/10 text-gray-400 transition-colors">
      ...
      {phase === 'intro' && (
          <div className="flex-1 flex flex-col items-center justify-center text-center animate-in fade-in">
              ...
              <button onClick={() => setShowGuide(true)} className="mt-6 text-xs text-gray-500 font-bold uppercase tracking-widest hover:text-primary transition-colors flex items-center gap-1">
                  <span className="material-symbols-outlined text-sm">info</span> ¿Cómo mejorar mi memoria?
              </button>
          </div>
      )}
